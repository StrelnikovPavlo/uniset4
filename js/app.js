(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".brands__slider")) new swiper_core_Swiper(".brands__slider", {
        ...
        if (document.querySelector(".products-carousel__slider")) new swiper_core_Swiper(".products-carousel__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    const buttonCatalog = document.querySelector(".bottom-header__catalog");
    if (buttonCatalog) {
        let catalogList = document.querySelector(".header-catalog");
